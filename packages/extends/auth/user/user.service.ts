import { PaginatorAdapter } from './../../../common/help/paginator.adapter';
import { WXBizDataCrypt } from './../../../plugin/wechat/wechat-biz-data-crypt';
...
@Injectable()
export class AuthUserService extends CommonService<AuthUser> {
  constructor(
    ...
    super(repo);
    this.options.exclude.push('password');
  }
  ...
  // 管理员列表
  async getManagerUsers(query: QueryDto) {
